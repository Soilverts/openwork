...
Try browser automation in Abel right away.
...
- Instead, tell the user the shortest exact steps to connect `Control Chrome` from Abel's MCP tab, then ask them to retry.
