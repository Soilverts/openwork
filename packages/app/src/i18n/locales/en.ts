 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, Abel) are NOT translated
 */
...
export default {
  ...
  "dashboard.hero_description": "Describe an outcome. Abel will run it and keep an audit trail.",
  ...
  "share_skill_destination.connect_remote_desc": "Attach an Abel host, then choose it from the list to import this skill.",
  ...
  "dashboard.remote_mode_openwork_alpha": "Abel server",
  "dashboard.remote_mode_direct": "Direct (legacy)",
  "dashboard.remote_connection_openwork": "Abel",
  ...
  "session.attach_connect_server": "Connect to Abel server to attach files.",
  ...
  // Share
  "session.share_invite_link": "Abel invite link",
  "session.share_worker_url": "Abel worker URL",
  ...
  "session.share_openwork_only": "Share service links are available for Abel workers.",
  "session.share_host_not_ready": "Local Abel host is not ready yet.",
  "session.share_missing_host_url": "Missing Abel host URL.",
  "session.share_missing_token": "Missing Abel token.",
  ...
  "session.setup_first_worker_desc": "Abel needs a local or remote worker before you can start a session.",
  ...
  "session.automate_browser_desc": "Set up browser actions and run reliable web tasks from Abel.",
  ...
  // Inbox upload
  "session.connect_to_upload": "Connect to the Abel server to upload inbox files.",
  ...
  "skills.host_only_error": "Skill management requires a local worker or connected Abel server.",
  ...
  "skills.connect_host_to_load": "Connect an Abel server to load skills.",
  ...
  "skills.add_custom_repo": "Add custom git repo",
  "skills.skills_count": "{count} skills",
  ...
  "skills.category.data": "Data & Analytics",
  "skills.category.documents": "Documents",
  "skills.category.human_resources": "Human Resources",
  "skills.category.legal": "Legal",
  "skills.category.operation": "Operation",
  "skills.category.sales": "Sales",
  ...
  // ==================== Apps (MCP) ====================
  "mcp.apps_title": "Apps",
  "mcp.apps_subtitle": "Connect your favorite tools so Abel can use them on your behalf.",
  ...
  "mcp.mcps_title": "Apps",
  "mcp.connect_mcp_hint": "Connect apps to expand what Abel can do.",
  ...
  "mcp.mcps_label": "Apps",
  "mcp.mcps_description": "Connect apps to expand what Abel can do.",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from Abel.",
  ...
  "mcp.auth.reload_notice": "For this to take effect, Abel needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_blocked": "Reload is paused while a session is running. Stop the run to finish setup.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, Abel needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize Abel",
  ...
  "settings.updates_description": "Keep Abel up to date.",
  ...
  "settings.advanced_description": "Reset Abel local state to retest onboarding.",
  "settings.reset_onboarding": "Reset onboarding",
  "settings.reset_onboarding_description": "Clears Abel preferences and restarts the app.",
  "settings.reset_app_data": "Reset app data",
  "settings.reset_app_data_description": "More aggressive. Clears Abel cache + app data.",
  ...
  "settings.reset_confirmation_hint": "Type <span class=\"font-mono\">RESET</span> to confirm. Abel will restart.",
  "settings.reset_onboarding_warning": "Clears Abel local preferences and worker onboarding markers.",
  "settings.reset_app_data_warning": "Clears Abel cache and app data on this device.",
  ...
  "settings.updates_hint": "Keep Abel up to date.",
  ...
  "settings.advanced_hint": "Reset Abel local state to retest onboarding.",
  "settings.reset_onboarding_label": "Reset onboarding",
  "settings.reset_onboarding_hint": "Clears Abel preferences and restarts the app.",
  "settings.reset_app_data_label": "Reset app data",
  "settings.reset_app_data_hint": "More aggressive. Clears Abel cache + app data.",
  ...
  "settings.reconnected_server": "Reconnected to Abel server.",
  "settings.failed_reconnect_server": "Failed to reconnect Abel server.",
  ...
  "settings.runtime_hint": "Status for your local engine and Abel server.",
  ...
  "settings.openwork_server_title": "Abel server",
  ...
  "settings.nuke_dev_config_description": "Deletes isolated OpenCode dev state and then quits Abel.",
  "settings.nuke_dev_config_confirm": "Delete the isolated OpenCode dev config and auth/data state, then quit Abel? This only affects dev-mode state.",
  "settings.nuke_dev_config_success": "Removed OpenCode dev state. Abel is closing...",
  ...
  "settings.background_checks_hint": "Abel always checks on launch. Also checks once per day (quiet).",
  ...
  "settings.feedback_title": "Help shape Abel",
  ...
  "settings.custom_binary_hint": "Use this to point Abel at a local OpenCode build (e.g. your fork). Applies next time the engine starts or reloads.",
  ...
  "settings.label_openwork_server": "Abel server",
  ...
  // Docker
  "settings.docker_containers_title": "Abel Docker containers",
  "settings.docker_containers_hint": "Force-remove Docker containers launched by Abel (sandbox + local dev stacks).",
  ...
  "settings.restart_openwork_server": "Restart Abel server",
  ...
  // Diagnostics
  "settings.server_diagnostics_title": "Abel server diagnostics",
  "settings.diagnostics_unavailable": "Diagnostics unavailable.",
  "settings.server_capabilities_title": "Abel server capabilities",
  ...
  // ==================== Onboarding ====================
  "onboarding.starting_host": "Starting Abel server...",
  "onboarding.searching_host": "Connecting to Abel server...",
  ...
  "onboarding.windows_install_instruction": "Install OpenCode for Windows, then restart Abel. Ensure opencode.exe is on PATH.",
  ...
  "onboarding.cli_install_commands": "Install OpenCode with one of the commands below, then restart Abel.",
  ...
  "onboarding.remote_workspace_title": "Connect to Abel server",
  "onboarding.remote_workspace_description": "Connect to an Abel server to access a worker from anywhere.",
  "onboarding.remote_workspace_action": "Connect",
  "onboarding.remote_workspace_card_title": "Connect a remote worker",
  "onboarding.remote_workspace_card_description": "Connect to an Abel server to access a shared worker.",
  "onboarding.advanced_openwork_host": "Abel server",
  ...
  "onboarding.welcome_title": "How would you like to run Abel today?",
  "onboarding.run_local": "Run locally",
  "onboarding.run_local_description": "Abel runs OpenCode locally and keeps your work private.",
  ...
  "onboarding.default_workspace_path": "~/Abel/Worker",
  ...
  "config.reload_local_only": "Reloading is only available for local workers or connected Abel servers.",
  ...
  "config.copy": "Copy",
  "config.server_sharing": "Abel server sharing",
  ...
  "config.server_url_label": "Abel Server URL",
  ...
  "config.openwork_server": "Abel server",
  "config.openwork_server_description": "Connect to an Abel server. Use the URL and access token from your server admin.",
  "config.server_url_input_label": "Abel server URL",
  "config.server_url_input_hint": "Use the URL shared by your Abel server.",
  ...
  "config.server_connection_needed": "Abel server connection needed to sync skills, plugins, and commands.",
  ...
  "app.migration.restart_failed": "Migration completed, but Abel could not restart the local engine.",
  ...
  "scheduled.reload_to_activate": "Reload Abel to activate automations",
  "scheduled.install_scheduler_unlock": "Install the scheduler to unlock automations",
  "scheduled.reload_activate_desc": "OpenCode loads plugins at startup. Reload Abel to activate opencode-scheduler.",
  ...
  "scheduled.reload_openwork": "Reload Abel",
  "scheduled.view_docs": "View docs",
  "scheduled.server_unavailable": "Abel server unavailable. Connect to sync scheduled tasks.",
  ...
  "scheduled.remote_description": "Automations that run on a schedule from the connected Abel server.",
  "scheduled.local_description": "Automations that run on a schedule from this device.",
  "scheduled.from_remote": "From Abel server",
  "scheduled.from_local": "From local scheduler",
  "scheduled.scheduler_remote": "Abel server",
  "scheduled.scheduler_local": "Local",
  "scheduled.hint_remote": "Remote instance",
  "scheduled.hint_local": "Launchd or systemd",
  "scheduled.unavailable_remote": "Abel server unavailable",
  "scheduled.unavailable_local": "Desktop-only",
  "scheduled.delete_remote_desc": "This removes the schedule and deletes the job definition from the connected Abel server.",
  ...
  "identities.connect_server": "Connect to an Abel server",
  "identities.connect_server_hint": "Identities are available when you are connected to an Abel host.",
  ...
  "identities.reconnect_failed": "Reconnect failed. Check Abel URL/token and try again.",
  ...
  "provider_auth.sign_in_desc": "Sign in to services you want Abel to use.",
